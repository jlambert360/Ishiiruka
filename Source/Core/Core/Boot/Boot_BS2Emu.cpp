...
void CBoot::SetupGCMemory()
{
  ...
  PowerPC::HostWrite_U32(Memory::0x04000000, 0x80000028);
...
bool CBoot::SetupWiiMemory()
{
  ...
  */
  ...
  Memory::Write_U32(0x04000000, 0x00000028);            // MEM1 size 64MB (was Memory::REALRAM_SIZE)
  Memory::Write_U32(0x00000023, 0x0000002c);            // Production Board Model
  Memory::Write_U32(0x00000000, 0x00000030);            // Init
  Memory::Write_U32(0x817FEC60, 0x00000034);            // Init
                                                        // 38, 3C should get start, size of FST through apploader
  Memory::Write_U32(0x8008f7b8, 0x000000e4);            // Thread Init
  Memory::Write_U32(0x04000000, 0x000000f0);            // "Simulated memory size" 64MB (was Memory::REALRAM_SIZE)
